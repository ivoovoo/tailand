...
function CurrentProjects() {
  return (
    <>
      ...
      >
        <Wrapper>
          <div className="relative w-full h-[40vh] sm:h-[60vh] xl:h-screen">
            ...
            <div className="absolute top-1/2 right-[20px] md:right-[200px] transform -translate-y-1/2 w-[60px] md:w-[80px] lg:w-[100px]">
              <svg className="w-[60px] md:w-[80px] lg:w-[100px]" xmlns="http://www.w3.org/2000/svg" width="127" height="127" viewBox="0 0 127 127" fill="none">
