...
export const commands = [
  {
    picture: "/newTeamUser1.jpg",
    fullName: "Давид Никурадзе",
    job: "Управляющий партнер",
    userComment:
      "Визионер, Главный архитектор, управляющий партнер архитектурного бюро  SPECTRUM",
  },
  {
    picture: "/lg4.jpg",
...
function OurCommands() {
  ...
  return (
    <Wrapper>
      <h1 className="text-[30px] md:text-[55px] lg:leading-[60px] lg:text-[65px] text-center py-[50px] md:py-[100px]">
        Наша <br /> Команда
      </h1>
          ...
          {commands.map((user, index) => (
            <SwiperSlide key={index}>
              <motion.div
                ...
                className="flex flex-col md:flex-row items-center md:items-start gap-[50px] md:gap-[100px] justify-center bg-[#23303F] text-white py-[20px] md:py-[50px] px-[15px] md:px-[50px] lg:px-[80px]"
              >
                <div className="md:w-1/2">
                  <h3 className="text-[24px] md:text-[32px] font-[500] uppercase text-center md:text-start">
                    {user.fullName}
                  </h3>
                  <img src={user.picture} className="mt-[25px] h-[290px] w-[225px] rounded-full object-cover" />
                </div>
                <div>
                  <h4 className="text-[24px] md:text-[32px] font-[500]">
                    {user.job}
                  </h4>
                  <div className="mt-[40px] bg-white py-[15px] px-[25px] md:px-[35px] rounded-[20px] max-w-[630px] text-black text-[20px] md:text-[30px] md:leading-[42px] font-[400]">
